define(['talent','$','views/common/modal/phoeon-modal'],function(Talent,$,PhoeonModal){
var root = window.top;
// root.modal_ = {
// 	//实例存放数组
// 	modalInstancesCount : 0
// };
console.log(root.Modal)
return Talent.ItemView.extend(root.Modal.prototype
// {
