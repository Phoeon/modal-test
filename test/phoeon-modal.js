...
var data = arguments[0] , t__ = [] ; with (data) {  t__.push('<div class="phoeon-modal phoeon-page-dimension pos-fix"> <div class="phoeon-mask phoeon-page-dimension pos-abs"></div> <div class="phoeon-dialog-container phoeon-page-dimension pos-abs"> <div class="phoeon-dialog pos-abs"> <div class="phoeon-dialog-bar phoeon-dialog-header"> <h3 class="phoeon-dialog-header-title">header</h3> <div class="phoeon-dialog-movehandler"></div> <div class="phoeon-dialog-opers"> <div class="phoeon-oper phoeon-max-action" data-text="﹣"><div class="phoeon-oper-bg phoeon-trans-bg"></div>□</div> <div class="phoeon-oper phoeon-close-btn phoeon-close-action"><div class="phoeon-oper-bg phoeon-trans-bg"></div>×</div> </div> </div> <div class="phoeon-dialog-body"> <div class="phoeon-content">content</div> </div> <div class="phoeon-dialog-bar phoeon-dialog-footer"> <h3 class="phoeon-dialog-footer-title">footer</h3> <div class="phoeon-operation"> <label class="phoeon-btn phoeon-ok-btn phoeon-ok-action">ok</label> <label class="phoeon-btn phoeon-cancel-btn phoeon-close-action">cancel </label> </div> </div> </div> </div> </div>') ;  } ; return t__.join('') ;
	...
	position_ : function(conf){
		this.body.css({
			top    : this.conf_.showHeader?40:0,
			bottom : this.conf_.showFooter?40:0
		})
